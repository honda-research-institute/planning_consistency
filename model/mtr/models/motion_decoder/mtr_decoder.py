...
from model.mtr.models.utils.transformer import position_encoding_utils
from model.mtr.models.utils import common_layers
from model.mtr.utils import loss_utils
from model.mtr.utils import motion_utils
...
class MTRDecoder(nn.Module):
    ...
    def get_loss(self, tb_pre_tag=''):
        ...
        return total_loss, loss_decoder, loss_dense_prediction
    ...
    def forward(self, batch_dict, to_predict=False):
        ...
        # TODO: unpack pred_list
        # pred_list has length of num_decoder_layers.
        # Each element is a tuple of (pred_scores, pred_trajs)
        # pred_scores: (num_center_objects, num_query)
        # pred_trajs: (num_center_objects, num_query, num_future_timestamps, 7)
